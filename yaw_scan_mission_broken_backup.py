...
print("Starting offboard yaw scan...")
...
# Start perception while yawing slowly
perception_task = asyncio.create_task(perception_loop(duration_s=25))

print("Yaw scan right...")
await drone.offboard.set_velocity_body(
